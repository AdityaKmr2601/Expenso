            ...
            child: Container(
              ...
              child: ListTile(
                ...
                subtitle: Text(
                    "${widget.dateTime.day
                        .toString()
                        .length == 1 ? '0' : ''}${widget.dateTime.day}/${widget
                        .dateTime.month
                        .toString()
                        .length == 1 ? '0' : ''}${widget.dateTime
                        .month}/${widget.dateTime.year}    ${widget.dateTime
                        .hour
                        .toString()
                        .length == 1 ? '0' : ''}${widget.dateTime.hour}:${widget
                        .dateTime.minute
                        .toString()
                        .length == 1 ? '0' : ''}${widget.dateTime.minute}"),
                trailing: Text(
                  "₹${widget.amount
                      .toString()
                      .length == 1 ? '0' : ''}${widget.amount}",
                  style: const TextStyle(fontWeight: FontWeight.bold),
                ),
              ),
            ),
